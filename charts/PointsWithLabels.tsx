...
export class PointsWithLabels extends React.Component<PointsWithLabelsProps> {
    ...
    @computed private get renderData(): ScatterRenderSeries[] {
        ...
        this.hideTooManySampleLabels(labelsByPriority, 300)
        this.hideCollidingLabelsByPriority(labelsByPriority)

        return renderData
    }

    private hideTooManySampleLabels(
        labelsByPriority: ScatterLabel[],
        maxLabels: number
    ) {
        // Here I define "Sample" labels as ones that we are showing automatically but are not selected or hovered.
        labelsByPriority
